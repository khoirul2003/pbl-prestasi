...
class AcademicController extends Controller
{
    ...
    public function indexStudentPeriod(Request $request)
    {
        ...
        return view('admin.student_periods.index', compact(
            'studentPeriods',
            'students',
            'periods'
        ));
    ...
    public function storeStudentPeriod(Request $request)
    {
        ...
        return redirect()->route('admin.student_periods.index')->with('success', 'Student period berhasil ditambahkan');
    }
    ...
    public function editStudentPeriod($id)
    {
        ...
        return view('admin.student_periods.edit', compact('studentPeriod', 'students', 'periods'));
    }
    ...
    public function updateStudentPeriod(Request $request, $id)
    {
        ...
        return redirect()->route('admin.student_periods.index')->with('success', 'Student period berhasil diperbarui');
    }
    ...
    public function destroyStudentPeriod($id)
    {
        ...
        return redirect()->route('admin.student_periods.index')->with('success', 'Student period berhasil dihapus');
    }
