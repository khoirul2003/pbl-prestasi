                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="border rounded p-2 bg-light text-center" style="min-height: 360px;">
                                <img id="filePreview" src="#" alt="Preview"
                                     style="max-width: 100%; max-height: 440px; display: none; border-radius: 10px;">
                            </div>
                        </div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" name="competition_registration_link">
                            </div>

                            <div class="mb-3">
                                <label for="competition_document" class="form-label">Upload Document</label>
                                <input type="file" class="form-control" name="competition_document"
                                       accept=".pdf,.docx,.jpg,.jpeg,.png" onchange="previewFile(event)" required>
